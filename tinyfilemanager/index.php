<?php
// router.php
if (preg_match('/(?:index_files)/', $_SERVER["REQUEST_URI"])) {
    return false;    // 直接返回请求的文件
}

//Default Configuration
$CONFIG = '{"lang":"zh-CN","error_reporting":false,"show_hidden":false,"hide_Cols":false,"calc_folder":true}';
...
// Generate secure password hash - ://tinyfilemanager.github.io/docs/pwd.html
$auth_users = array(
    'admin' => '$2y$10$g5jC0kF9J7/e.w9heTonzeR4I/aT1uCnxa1W7jIqZmLPHJu3vMimS', //admin@123
    'user' => '$2y$10$zTyTnR7QYRj4zlYD9ZsZzOCagZ.qjew8Ms3iOzv663C1J0UDuaUry' //1
);
...
// Enable highlight.js (://highlightjs.org/) on view's page
...
// Enable ace.js (://ace.c9.io/) on view's page
$edit_files = true;

// Default timezone for date() and time()
// Doc - ://php.net/manual/en/timezones.php
...
// Doc - ://www.php.net/manual/en/function.date.php
...
// full path, e.g //example.com/favicon.png
// local path, e.g images/icons/favicon.png
$favicon_path = '?img=favicon';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('.vnc','passwd.txt');
...
$config_file = 'index_files/index_config.php';
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <link href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/dropzone.min.css') ?>" rel="stylesheet">
    <div class="path">
    ...
    <script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/dropzone.min.js') ?>"></script>
    <script>
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('index_files/index_translation.json');
        if($content !== FALSE) {
...
//stackoverflow.com/a/13821992/1164642
*/
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/bootstrap.min.css') ?>">
    <style>
...
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/jquery.slim.min.js') ?>"></script>
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/bootstrap.min.js') ?>"></script>
</body>
</html>
<?php
}
...
<head>
    ...
    <title><?php echo fm_enc(APP_TITLE) ?></title>
    <link rel="stylesheet" href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/font-awesome.min.css') ?>">
    <link rel="stylesheet" href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/ekko-lightbox.css') ?>" />
    <?php if (FM_USE_HIGHLIGHTJS): ?>
    <link rel="stylesheet" href="<?php echo fm_enc(FM_ROOT_URL . '/index_files/css/') ?><?php echo FM_HIGHLIGHTJS_STYLE ?>.min.css">
    <?php endif; ?>
    <style>
...
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/jquery.min.js') ?>"></script>
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/bootstrap.min.js') ?>"></script>
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/jquery.dataTables.min.js') ?>"></script>
<script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/ekko-lightbox.min.js') ?>"></script>
<?php if (FM_USE_HIGHLIGHTJS): ?>
    <script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/highlight.min.js') ?>"></script>
...
<script>
    ...
    //TFM Config
    window.curi = "<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/ace.json') ?>", window.config = null;
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE): 
        ...
        ?>
    <script src="<?php echo fm_enc(FM_ROOT_URL . '/index_files/js/ace.js') ?>"></script>
    <script>
